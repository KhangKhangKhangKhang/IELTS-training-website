...
// SENTENCE_COMPLETION
// BE metadata: { sentenceWithBlank: string, maxWords: number, correctAnswers: string[] }
const defaultValue = () => ({
  sentenceWithBlank: "",
  maxWords: 1,
  correctAnswers: [""],
...
const SentenceCompletionForm = ({ value = defaultValue(), onChange }) => {
