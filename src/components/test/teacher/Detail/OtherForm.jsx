...
const OtherForm = ({ idGroup, groupData, questionNumberOffset = 0, onRefresh }) => {
  ...
  const handleSaveAll = async () => {
    try {
      ...
      message.success("Đã lưu tất cả câu hỏi OTHER!");
  ...
  const handleSaveEdit = async () => {
    try {
      ...
      message.success("Đã cập nhật câu hỏi OTHER!");
