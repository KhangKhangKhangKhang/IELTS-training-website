...
export function Tag({
  ...
  tone: 'writing' | 'speaking' | 'pending' | 'claimed' | 'completed' | 'slate';
  children: React.ReactNode;
}) {
...
export function PillButton({
  ...
  const styles: Record<string, string> = {
    ...
    green: 'bg-[#10b981] text-white shadow-[0_3px_0_#047857] hover:brightness-110 active:translate-y-[2px] active:shadow-[0_1px_0_#047857]',
